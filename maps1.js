...
var beechwoodwestPoly = new google.maps.Polygon({
    paths: beechwoodwestCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#8ACD80',
...
var clairhillsPoly = new google.maps.Polygon({
    paths: clairhillsCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#AD9A54',
...
var vistahillsPoly = new google.maps.Polygon({
    paths: vistahillsCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#54AD85',
...
var columbiaforestPoly = new google.maps.Polygon({
    paths: columbiaforestCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#E4475C',
...
var westvalePoly = new google.maps.Polygon({
    paths: westvaleCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#95B162',
...
var marplehillsPoly = new google.maps.Polygon({
    paths: marplehillsCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#B7B08B',
...
var westmountPoly = new google.maps.Polygon({
    paths: westmountCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#67590C',
...
var uptownwaterlooPoly = new google.maps.Polygon({
    paths: uptownwaterlooCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#E67FA0',
...
var cityofwaterlooPoly = new google.maps.Polygon({
    paths: cityofwaterlooCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#81D799',
...
var laurelwoodPoly = new google.maps.Polygon({
    paths: laurelwoodCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#E7DB7E',
...
var conservationmeadowsPoly = new google.maps.Polygon({
    paths: conservationmeadowsCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#6D652B',
...
var northlakeshorePoly = new google.maps.Polygon({
    paths: northlakeshoreCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#6D652B',
...
var lakeshorePoly = new google.maps.Polygon({
    paths: lakeshoreCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#6D162B',
...
var colonialacresPoly = new google.maps.Polygon({
    paths: colonialacresCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#6D137B',
...
var lincolnvillagePoly = new google.maps.Polygon({
    paths: lincolnvillageCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#6D607B',
...
var lincolnheightsPoly = new google.maps.Polygon({
    paths: lincolnheightsCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#6D607B',
...
var eastbridgePoly = new google.maps.Polygon({
    paths: eastbridgeCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#6D634B',
...
var lexingtonPoly = new google.maps.Polygon({
    paths: lexingtonCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#6D634B',
...
var universitydownsPoly = new google.maps.Polygon({
    paths: universitydownsCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#6D634B',
...
var kiwanisparkPoly = new google.maps.Polygon({
    paths: kiwanisparkCoords,
    strokeColor: '#000000',
    strokeOpacity: 0.2,
    strokeWeight: 2,
    fillColor: '#6D634B',
  ...
  //                 '</div>';
    var contentString = [
  '<div id="tabs" class="tabs-nohdr" style="color:#0000FF">',
  '<ul>',
  ...
  // add polygons to the map
    ...
    beechwoodwestPoly.setMap(map);
    clairhillsPoly.setMap(map);
    vistahillsPoly.setMap(map);
    columbiaforestPoly.setMap(map);
    westvalePoly.setMap(map);
    marplehillsPoly.setMap(map);
    westmountPoly.setMap(map);
    uptownwaterlooPoly.setMap(map);
    cityofwaterlooPoly.setMap(map);
    laurelwoodPoly.setMap(map);
    conservationmeadowsPoly.setMap(map);
    northlakeshorePoly.setMap(map);
    lakeshorePoly.setMap(map);
    colonialacresPoly.setMap(map);
    lincolnvillagePoly.setMap(map);
    lincolnheightsPoly.setMap(map);
    eastbridgePoly.setMap(map);
    lexingtonPoly.setMap(map);
    universitydownsPoly.setMap(map);
    kiwanisparkPoly.setMap(map);
